...
class Searching():
    ...
    def global_search(self, pages):
        ...
        try:
            os.mkdir(f'/home/fostin/delivery/pythonorienté/projet5/Ressources/{name}') #make a new directory for the product
        ...
        while x <= pages:
            ...
            completeName = os.path.join(f'/home/fostin/delivery/pythonorienté/projet5/Ressources/{name}', f"{name}{y}.json")
